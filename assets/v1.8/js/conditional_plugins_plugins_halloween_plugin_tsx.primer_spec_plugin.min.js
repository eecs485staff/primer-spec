"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["conditional_plugins_plugins_halloween_plugin_tsx"],{

/***/ "./conditional_plugins/plugins/halloween.plugin.tsx":
/*!**********************************************************!*\
  !*** ./conditional_plugins/plugins/halloween.plugin.tsx ***!
  \**********************************************************/
...
/* harmony export */   "default": () => (/* binding */ HalloweenPlugin)
/* harmony export */ });
...
function createGhostEasterEggOnClick(event) {
    ...
    startX -= ghostSize / 2;
    startY -= ghostSize / 2;
    const easterEggEmoji = (jsx_dom__WEBPACK_IMPORTED_MODULE_0__.h("span", { style: `position: fixed; top: ${startY}px; left: ${startX}px; z-index: 1000; font-size: ${ghostSize}px; transition: all 1s ease-out; user-select: none;` }, "\uD83D\uDC7B"));
...
function insertPumpkinsInThemePreview() {
    document
        ...
        if (!svg.querySelector('.spooky-pumpkins')) {
            svg.appendChild(jsx_dom__WEBPACK_IMPORTED_MODULE_0__.h("text", { class: "spooky-pumpkins", x: "180", y: "130", "dominant-baseline": "middle", "text-anchor": "middle", style: "font-size: 72px;" }, "\uD83C\uDF83\uD83C\uDF83\uD83C\uDF83"));
        }
    });
}
...
function constructHalloweenSubtheme() {
    ...
    document.head.appendChild(jsx_dom__WEBPACK_IMPORTED_MODULE_0__.h("link", { href: "https://fonts.googleapis.com/css2?family=Creepster&family=Architects+Daughter&display=swap", rel: "stylesheet" }));
...
function toggleFontIfNeeded(subtheme_name) {
    ...
    if (subtheme_name === 'spooky' && !existingStyleTag) {
        document.body.appendChild(jsx_dom__WEBPACK_IMPORTED_MODULE_0__.h("style", { id: "primer-spec-halloween-font" },
...
function insertShyEmojiImpl(subtheme_name) {
    ...
    const shyEmojiKeyframes = (jsx_dom__WEBPACK_IMPORTED_MODULE_0__.h("style", { id: keyframesCssId },
    ...
    jsx_dom__WEBPACK_IMPORTED_MODULE_0__.h("span", { id: emojiSpanId, style: `position: fixed; top: ${initHeight}%; ${peakFromMargin}: -70px; font-size: 60px; z-index: 1000; user-select: none; cursor: pointer;`, onClick: () => {
...
//# sourceMappingURL=conditional_plugins_plugins_halloween_plugin_tsx.primer_spec_plugin.min.js.map