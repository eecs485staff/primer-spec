...
const slack_light_theme_vars: SubthemeVarsType = {
  ...
  '--sidebar-toc-h1-link-color': SLACK_LIGHT_SIDEBAR_TEXT_COLOR,
  '--sidebar-toc-h1-border-color': SLACK_LIGHT_SIDEBAR_TEXT_COLOR,
  '--sidebar-toc-h2-link-color': SLACK_LIGHT_SIDEBAR_TEXT_COLOR,
