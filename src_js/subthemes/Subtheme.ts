...
export const ROUGE_CLASS_NAMES = [
  'cm', 'cp', 'c1', 'cs', 'cd', 'c',
  'err', 'gd', 'ge', 'gr', 'gh', 'gi', 'go', 'gp', 'gs', 'gu', 'gt',
  'kc', 'kd', 'kn', 'kp', 'kr', 'kt', 'kv', 'k',
  'mf', 'mh', 'il', 'mi', 'mo', 'mb', 'mx', 'm',
  'sb', 'sc', 'sd', 's2', 'se', 'sh', 'si', 'sx', 'sr', 's1', 'ss', 's',
  'na', 'bp', 'nb', 'nc', 'no', 'nd', 'ni', 'ne', 'nf', 'nl', 'nn', 'nt', 'vc', 'vg', 'vi', 'nv',
  'ow', 'o', 'w', 'txt',
];
